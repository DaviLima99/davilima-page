...
t1.fromTo(phpBar, .70, {width: `calc(0% - 6px)`}, {width: `calc(86% - 6px)`, height: `20px`, ease: Power4.easeOut})
    .fromTo(javaBar, .70, {width: `calc(0% - 6px)`}, {width: `calc(68% - 6px)`, height: `20px`, ease: Power4.easeOut})
    ...
    .fromTo(mysqlBar, .75, {width: `calc(0% - 6px)`}, {width: `calc(82% - 6px)`, height: `20px`, ease: Power4.easeOut})
    .fromTo(mongoBar, .75, {width: `calc(0% - 6px)`}, {width: `calc(50% - 6px)`, height: `20px`, ease: Power4.easeOut})
    .fromTo(symfonyBar, .75, {width: `calc(0% - 6px)`}, {width: `calc(72% - 6px)`, height: `20px`, ease: Power4.easeOut})
    .fromTo(reactBar, .75, {width: `calc(0% - 6px)`}, {width: `calc(63% - 6px)`, height: `20px`, ease: Power4.easeOut});
